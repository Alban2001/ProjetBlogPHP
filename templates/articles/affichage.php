                        ...
                        <div class="card col-12 col-md-4 ms-0 ms-md-3 mb-5" style="width: 20rem;">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text"><small class="text-muted">
                                        <?php print_r("Dernière modification : " . htmlspecialchars($article->getDateDerniereMaj()->format("d/m/Y"))); ?>
                                    </small></p>
                                <a href="index.php?action=read&id=<?php print_r(htmlspecialchars($article->getId())); ?>"
